...
## 🎛️ How It Works
Open the **[Interactive Studio](https://pradeeptalari14.github.io/portfolio/tools/injection-catcher/)** in your portfolio dashboard to customize options, select webhook notification channels (Slack/Teams), toggle chat bot connections (WhatsApp Business/Telegram Bot), and download compiled deployment scripts dynamically.
...
```bash
git clone https://github.com/Pradeeptalari14/tp-injection-catcher.git
cd tp-injection-catcher
```
...
```bash
kubectl port-forward deployment/tp-injection-catcher 8080:8080 || echo "Port forwarding enabled on localhost:8080"
```
...
└── primary_config/
    └── injection_detector.py     # Main configuration file
```
...
---
*Generated by [Injection Catcher Studio](https://pradeeptalari14.github.io/portfolio/tools/injection-catcher/) — [Talari Pradeep SRE Portfolio](https://pradeeptalari14.github.io/portfolio)*
